...
<title>Kereta Sewa Ganu | Senarai Testimoni </title>
<!--Bootstrap -->
  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1>Senarai Testimoni</h1>
      </div>
      <ul class="coustom-breadcrumb">
        <li><a href="#">Utama</a></li>
        <li>Senarai Testimoni</li>
      </ul>
    </div>
  </div>
  <!-- Dark Overlay-->
  ...
  <div class="row">
      ...
      <div class="col-md-8 col-sm-8">
        ...
        <div class="profile_wrap">
          <h5 class="uppercase underline">Senarai Testimoni </h5>
              ...
              <li>
                ...
                <?php if($result->status==1){ ?>
                 <div class="vehicle_status"> <a class="btn outline btn-xs active-btn">Aktif</a>
                  ...
                  <?php } else {?>
               <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Menunggu Pengesahan</a>
                  <div class="clearfix"></div>
                  </div>
                  <?php } ?>
              </li>
