...
<head>
  ...
  <title>Kereta Sewa Ganu | Car Listing</title>
  <!--Bootstrap -->
    ...
    <div class="container">
      <div class="page-header_wrap">
        <div class="page-heading">
          <h1>Senarai Kereta Sewa</h1>
        </div>
        <ul class="coustom-breadcrumb">
          <li><a href="#">Utama</a></li>
          <li>Senarai Kereta Sewa</li>
        </ul>
      </div>
    </div>
    <!-- Dark Overlay-->
        ...
        <div class="col-md-9 col-md-push-3">
          <div class="result-sorting-wrapper">
            <div class="sorting-count">
              ...
              $cnt = $query->rowCount();
              ?>
              <p><span><?php echo htmlentities($cnt); ?> Rekod</span></p>
            </div>
          </div>
            ...
            foreach ($results as $result) {  ?>
              <div class="product-listing-m gray-bg">
                ...
                <div class="product-listing-content">
                  ...
                  <p class="list-price">RM<?php echo htmlentities($result->PricePerDay); ?>/1 Hari</p>
                  <ul>
                  ...
                  <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id); ?>" class="btn">Lihat Info <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
                </div>
              </div>
          <?php }
          } ?>
        ...
        <aside class="col-md-3 col-md-pull-9">
          <div class="sidebar_widget">
            <div class="widget_heading">
              <h5><i class="fa fa-filter" aria-hidden="true"></i> Carian Kereta Sewa </h5>
            </div>
          ...
          <div class="sidebar_widget">
            <div class="widget_heading">
              <h5><i class="fa fa-car" aria-hidden="true"></i> Terkini Dimasukkan</h5>
            </div>
                  ...
                  foreach ($results as $result) {  ?>
                    ...
                    <li class="gray-bg">
                      ...
                      <div class="recent_post_title"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id); ?>"><?php echo htmlentities($result->BrandName); ?> , <?php echo htmlentities($result->VehiclesTitle); ?></a>
                        <p class="widget_price">RM<?php echo htmlentities($result->PricePerDay); ?>/1 Hari</p>
                      </div>
                    </li>
                <?php }
                } ?>
