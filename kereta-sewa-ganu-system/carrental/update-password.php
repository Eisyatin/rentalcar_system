...
<title>Kereta Sewa Ganu - Kemaskini Kata Laluan</title>
<!--Bootstrap -->
...
<form name="chngpwd" method="post" onSubmit="return valid();">
            ...
            <div class="form-group">
              <label class="control-label">Katalaluan semasa<small><i>&nbsp;(Current Password)</i></small></label>
            ...
            <div class="form-group">
              <label class="control-label">Pengesahan Kata Laluan<small><i>&nbsp;(Confirm Password)</i></small></label>
              <input class="form-control white_bg" id="confirmpassword" type="password" name="confirmpassword"  required>
            </div>
          
            <div class="form-group">
               <input type="submit" value="Kemaskini" name="updatepass" id="submit" class="btn btn-block">
            </div>
          </form>
        </div>
      </div>
