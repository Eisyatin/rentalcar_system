...
if (isset($_POST['submit'])) {
  ...
  if ($query1->rowCount() == 0) {
    try {
      ...
      $bookNo = $dbh->lastInsertId();
      $start = new DateTime($fromdate);
      $end = new DateTime($todate);

      $interval = $start->diff($end);
      $days = $interval->days;
      $amount = $_POST['priceperday'] * $days;
      $vimage1 = $_FILES["img1"]["name"];
      if (empty($image)) {
        $vimage1 = "default-avatar.jpeg";
      }
      move_uploaded_file($_FILES["img1"]["tmp_name"], "uploads/" . $_FILES["img1"]["name"]);


      $sql = "INSERT INTO  tblpayment(bookingId,amount,status, image) VALUES(:bookNo,:amount,:status, :vimage1)";
      $query = $dbh->prepare($sql);
      // $query->bindParam(':idPayment', $idPayment, PDO::PARAM_STR);
...
<head>
  ...
  <title>Kereta Sewa Ganu | Info Kenderaan</title>
  <!--Bootstrap -->
          ...
          <div class="listing_detail_head row">
            ...
            <div class="col-md-3">
              <div class="price_info">
                <p>RM<?php echo htmlentities($result->PricePerDay); ?> </i></p>/1 Hari
                ...
                <div class="listing_detail_wrap">
                  ...
                  <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane active" id="vehicle-overview">
                      ...
                      <p><?php echo nl2br(strip_tags(substr($result->VehiclesOverview, 0, 70))); ?></p>
                    </div>
          ...
          <?php }
            ...
            <aside class="col-md-3">
              <div class="sidebar_widget">
                ...
                <form method="post">
                  <input type="hidden" name="priceperday" value="<?php echo htmlentities($result->PricePerDay); ?>">
                  ...
                  <div class="form-group">
                    <label>Dari:</label>
                    <input type="date" class="form-control" name="fromdate" placeholder="Dari" required>
                  </div>
                  <div class="form-group">
                    <label>Sehingga:</label>
                    <input type="date" class="form-control" name="todate" placeholder="Sehingga" required>
                  </div>
                  <div class="form-group">
                    <textarea rows="4" class="form-control" name="message" placeholder="Mesej"></textarea>
                  </div>
                  <?php if ($_SESSION['login']) { ?>
                    <div class="form-group">
                      <input type="submit" class="btn" name="submit" value="Sewa Sekarang">
                    </div>
                  <?php } else { ?>
                    <a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Login Untuk Sewa</a>
