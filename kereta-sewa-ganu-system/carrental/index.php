  ...
  <section class="section-padding gray-bg">
    <div class="container">
      <div class="section-header text-center">
        <h2>Jom Sewa Kereta <span>dengan KSG</span></h2>
        <p>Kami di KSG menyediakan servis sewa kereta pandu sendiri di Kuala Terengganu!</p>
      </div>
      <div class="container">
        <div class="row">
  ...
  <section class="section-padding testimonial-section parallex-bg">
    <div class="container div_zindex">
      <div class="section-header white-text text-center">
        <h2>Maklum Balas <span>Pelanggan</span></h2>
      </div>
      <div class="row">
