...
<title>Kereta Sewa Ganu | Profil</title>
<!--Bootstrap -->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Maklumat Akaun</h5>
          <?php  
         if($msg){?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post">
           <div class="form-group">
              <label class="control-label">Tarikh Daftar -</label>
             <?php echo htmlentities($result->RegDate);?>
            </div>
             <?php if($result->UpdationDate!=""){?>
            <div class="form-group">
              <label class="control-label">Pengemaskinian Terkini  -</label>
            ...
            <div class="form-group">
              <label class="control-label">Tarikh Lahir&nbsp;(dd/mm/yyyy)</label>
