		...
		<ul class="ts-sidebar-menu">
			...
			<li><a href="#"><i class="fa fa-sitemap"></i> Bookings</a>
				<ul>
					...
					<li><a href="completed-bookings.php">Completed</a></li>
				</ul>
			</li>
			...
			<li><a href="#"><i class="fa fa-question-circle"></i> FAQs</a>
				<ul>
					<li><a href="create-faq.php">Create FAQs</a></li>
					<li><a href="manage-faqs.php">Manage FAQs</a></li>
				</ul>
			</li>
